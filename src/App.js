...
function App() {
  ...
  const contractAddress = "0x6E0144daEA93e4B52539220Bd6036f92B6fa87b7";
      ...
      <section className='customer-section px-10 pt-5 pb-10'>
        ...
        <div className='mt-5'>
          {currentBankName === '' && isBankOwner ? 
            ...
            <p className='text-3xl fond-bold'>{currentBankName}</p>
          }
        </div>

        <div className='mt-7 mb-9'>
          <form className='form-style'>
            <input type='text' className='input-style' onChange={handleInputChange} name='deposit' placeholder="0.0000 ETH" value={inputValue.deposit} />
        ...
        <div className='mt-10 mb-10'>
          <form className='form-style'>
            <input type='text' className='input-style' onChange={handleInputChange} name='withdraw' placeholder="0.0000 ETH" value={inputValue.withdraw} />
      ...
      </section>
      {
        isBankOwner && (
          <section className='bank-owner-section'>
            ...
            <div className='p-10'>
              <form className='form-style'>
                <input type='text' className='input-style' onChange={handleInputChange} name='bankName' placeholder="Enter a Name for Your Bank" value={inputValue.bankName} />
                <button className='btn-grey' onClick={setBankNameHandler}>Set Bank Name</button>
              </form>
            </div>
          </section>
        )
